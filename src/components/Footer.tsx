        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors"
              aria-label="GitHub"
            >
          ...
          <div className="text-center pt-4">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              © {new Date().getFullYear()} Nain Nolasco. All rights reserved.
            </p>
          </div>
        </div>
