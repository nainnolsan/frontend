...
import { BsClaude, BsThreeDots } from 'react-icons/bs';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-center lg:items-center justify-center lg:justify-start">
          ...
          <div className="flex flex-col justify-center items-center lg:items-start space-y-3">
            ...
            <a 
              href="https://www.facebook.com/nainisai.nolascosantander" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-black dark:text-white hover:opacity-60 transition-opacity"
            >
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            ...
            {/* More technologies */}
            <div className="group flex flex-col items-center justify-center gap-2 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-all cursor-pointer">
              <BsThreeDots className="w-8 h-8 text-gray-700 dark:text-white transition-colors" />
            </div>
          </div>
